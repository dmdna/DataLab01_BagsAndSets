...
public class BagLabTest {
	...
	public static void main(String[] args) {
		...
		/* Before removing anything, we've added a few tests for moreFrequentThan */
		System.out.println("Elements more frequent than Juan are:");
		printBag(theBag.moreFrequentThan("Juan"));
		System.out.println("Elements more frequent than Ned are:");
		printBag(theBag.moreFrequentThan("Ned"));
		System.out.println("Elements more frequent than Bob are:");
		printBag(theBag.moreFrequentThan("Bob"));
		
		theBag.eraseAll("Ned");
		System.out.println("Copies of Ned in the Bag after eraseAll: "+ theBag.count("Ned"));
		theBag.add("Bob");
		System.out.println("Copies of Bob in the Bag after add: "+ theBag.count("Bob"));
